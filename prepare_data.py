...
def parse_args():
    ...
    parser.add_argument('--config', type=str, dest='config',default='/home/zdk/RODNet-master/configs/config_rodnet_cdcv2_win16_mnet.py', help='configuration file path')
    parser.add_argument('--data_root', type=str,default='/home/zdk/RODNet-master',
    ...
    parser.add_argument('--out_data_dir', type=str, default='/home/zdk/RODNet-master/data/pkl',
...
def generate_confmaps(metadata_dict, n_class, viz):
    confmaps = []
    for metadata_frame in metadata_dict:                                        #对每一帧生成置信图               
    ...
    confmaps = confmaps.astype(np.float32)
    return confmaps
