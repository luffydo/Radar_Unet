...
from rodnet.models.uhrnet_backbone import ConvBnReLU 
# from rodnet.models.uhrnet_backbone import UHRNet_W48
BN_MOMENTUM = 0.1

class UHRnet(nn.Module):
    def __init__(self, num_classes = 3, backbone = 'UHRNet_W18_Small'):
        super(UHRnet, self).__init__()
        if backbone == 'UHRNet_W18_Small':
            from rodnet.models.uhrnet_backbone import UHRNet_W18_Small
