...
from rodnet.core.post_processing.ops import detect_peaks
from rodnet.core.post_processing.lnms import lnms
...
if __name__ == "__main__":
    input_test = np.random.random_sample((2, 3, 16, 5, 5))
    # a = input_test[0, :, 0, :, :]
    # b = input_test[1, :, 1, :, :]
