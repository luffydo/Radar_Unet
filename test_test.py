...
def parse_args():
    ...
    parser.add_argument('--checkpoint', default='/home/zdk/RODNet-master/checkpoints/156-Multibase-Aug-noattention-nomulti-cycli-loss(max_det15,1e-5)-20230330-094658/epoch_best.pkl', type=str, help='path to the saved trained model')
...
if __name__ == "__main__":
    ...
    for subset in seq_names:
        print(subset)
        if not args.demo:
            crdata_test = TESTDataset(data_dir=args.data_dir, dataset=dataset, config_dict=config_dict, split='test',
